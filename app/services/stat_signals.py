...
def confluence_score(ai_signal: str, ai_conf: float,
    ...
    if signal == "STRONG_BULLISH":
        interpretation = "Strong buy signal on this timeframe"
    elif signal == "BULLISH":
        interpretation = "Mild buy signal"
    elif signal == "STRONG_BEARISH":
        interpretation = "Strong sell/short signal on this timeframe"
    elif signal == "BEARISH":
        interpretation = "Mild sell signal"
    else:
        interpretation = "No clear signal - wait for confirmation"
